    ...
    return (
      <div className="w-75 mx-auto d-flex">
        <div className="form-group text-left w-50 m-4">
          ...
          <input className="form-control" id="sayWhat" aria-describedby="sayWhatHelp" onChange={this.handleInput} type="text" placeholder="Say It, Don't Spray It!" value={this.state.whatToSay}/>
